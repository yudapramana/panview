<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item"><a class="nav-link @if (request()->segment(1) == 'carousels') @else collapsed @endif" href="/carousels"><i class="'bi bi-display"></i><span>Carousels</span></a>
            {{-- <li class="nav-item"><a class="nav-link @if (request()->segment(1) == 'testimonies') @else collapsed @endif" href="/testimonies"><i class="'bi bi-person"></i><span>Testimonies</span></a> --}}
